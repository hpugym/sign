                ...
                <table class="table table-striped table-bordered table-hover table table-condensed table-responsive">
                    ...
                    @foreach($courses as $course)
                        <tr>
                            ...
                            <td style="color:blue;">{{$course->teachs_status  == 0 ? "在教" : "结课"}}</td>
                            <td><a href="{{url("signmanager/publish")."?teachs_code=".$course->teachs_code."&course_name=".$course->course_name}}">我要签到</a></td>
                        </tr>
                    @endforeach
                </table>
            </div>
