...
class Qrcode extends Model{
    ...
    //指定主键
//    protected $primaryKey = "qrcode_code";//这里主键不是整型的，不要定义为主键，主键一般被认为是自增ID，自增ID会被强制换位为int类型
    //指定允许批量赋值
    protected $fillable = ['qrcode_code','teachs_code_md5','qrcode_lon','qrcode_lat','teach_id','qrcode_add','qrcode_time'];
    //自动维护时间戳
     ...
     * @return array
     */
    public static function pageAction($obj,$page_num,$current_url){
        $data           = $obj->toArray();
