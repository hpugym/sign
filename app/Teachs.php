...
class Teachs extends Model{
    ...
    //指定主键
    protected $primaryKey = "teachs_id";
    //指定允许批量赋值
    protected $fillable = ['teachs_code','teachs_code_md5','course_num','teach_id','teachs_time','teachs_grade','teachs_stu','teachs_add','teachs_avai','teachs_status'];
    //自动维护时间戳
